    ...
    public class SubscriptionService
    {
        ...
        public void SubscriptionServiceRequest1()
        {
            ...
            GisGmpBuilder gisgmp = new GisGmpBuilder()
            {
                ...
                TestTimestamp = new DateTime(day: 30, month: 09, year: 2020, hour: 16, minute: 03, second: 25, millisecond: 932, kind: DateTimeKind.Local),
        ...
        public void SubscriptionServiceResponse1()
        {
            ...
            GisGmpBuilder gisgmp = new GisGmpBuilder()
            {
                ...
                TestTimestamp = new DateTime(day: 30, month: 09, year: 2020, hour: 16, minute: 04, second: 25, millisecond: 932, kind: DateTimeKind.Local),
